      ...
      <div class="col">
        <div class="card">
          <div class="card-body">
            ...
            <form class="p-4 p-md-5" method="POST" action="{{ route('store.jobs') }}" enctype="multipart/form-data">
                @csrf
              ...
              <div class="form-group">
                ...
                <input name="experience" type="text" class="form-control" id="" placeholder="Experience(years)">
              </div>

              <div class="form-group">
                <label for="job-location">Salary</label>
                <input name="salary" type="text" class="form-control" id="" placeholder="Sallery">
              </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <input type="submit" name="submit" class="btn btn-block btn-primary btn-md"
                      style="margin-left: 155px; margin-top: 20px;" value="Save Job">
                  </div>
                </div>
              </div>
