        ...
        <header class="site-navbar mt-3">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="site-logo col-6"><a href="{{ url('/') }}" style="text-decoration: none; font-weight:700;">Job Portal</a></div>
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        ...
                                        <a  class="dropdown-item" href="{{ route('saved_jobs') }}">Saved Jobs</a>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <p class="copyright"><small>
                            ...
                            </script> All rights reserved | Designed & Developed by Md. Saiful Islam
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </small></p>
                </div>
            </div>
